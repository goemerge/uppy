...
import getFileType from "@growthcloud/utils/lib/getFileType";
import getFileNameAndExtension from "@growthcloud/utils/lib/getFileNameAndExtension";
import generateFileID from "@growthcloud/utils/lib/generateFileID";
...
class Uppy {
  ...
  async #runUpload(uploadID) {
    ...
    if (currentUpload) {
      ...
      // introduced code in the @growthcloud/core upload-success handler to prepare postprocessing progress
