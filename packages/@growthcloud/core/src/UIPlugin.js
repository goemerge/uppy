...
import findDOMElement from "@growthcloud/utils/lib/findDOMElement";
import getTextDirection from "@growthcloud/utils/lib/getTextDirection";
  ...
  mount(target, plugin) {
    ...
    if (typeof target === "function") {
      message +=
        ...
        "If you are using @growthcloud/* packages directly, make sure you have only 1 version of @growthcloud/core installed: " +
        "run `npm ls @growthcloud/core` on the command line and verify that all the versions match and are deduped correctly.";
    } else {
      message +=
