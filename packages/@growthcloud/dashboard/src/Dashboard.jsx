...
import findAllDOMElements from "@growthcloud/utils/lib/findAllDOMElements";
import toArray from "@growthcloud/utils/lib/toArray";
import getDroppedFiles from "@growthcloud/utils/lib/getDroppedFiles";
import { nanoid } from "nanoid/non-secure";
import memoizeOne from "memoize-one";
import FOCUSABLE_ELEMENTS from "@growthcloud/utils/lib/FOCUSABLE_ELEMENTS";
...
export default class Dashboard extends UIPlugin {
  ...
  constructor(uppy, opts) {
    ...
    // set default options, must be kept in sync with packages/@growthcloud/react/src/DashboardModal.js
