...
import getSpeed from "@growthcloud/utils/lib/getSpeed";
import getBytesRemaining from "@growthcloud/utils/lib/getBytesRemaining";
...
export default class StatusBar extends UIPlugin {
  ...
  constructor(uppy, opts) {
    ...
    // set default options, must be kept in sync with @growthcloud/react/src/StatusBar.js
