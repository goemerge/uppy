...
class Uploader {
  ...
  saveState(state) {
    ...
    // https://github.com/goemerge/uppy/issues/3748
  ...
  #emitError(err) {
    ...
    // see PR discussion https://github.com/goemerge/uppy/pull/3832
  ...
  async _uploadS3Multipart(stream) {
    ...
    const upload = client.upload(params, {
      // using chunkSize as partSize too, see https://github.com/goemerge/uppy/pull/3511
