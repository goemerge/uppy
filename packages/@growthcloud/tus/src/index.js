...
import emitSocketProgress from "@growthcloud/utils/lib/emitSocketProgress";
import getSocketHost from "@growthcloud/utils/lib/getSocketHost";
import settle from "@growthcloud/utils/lib/settle";
import EventTracker from "@growthcloud/utils/lib/EventTracker";
import NetworkError from "@growthcloud/utils/lib/NetworkError";
import isNetworkError from "@growthcloud/utils/lib/isNetworkError";
import { RateLimitedQueue } from "@growthcloud/utils/lib/RateLimitedQueue";
import hasProperty from "@growthcloud/utils/lib/hasProperty";
...
/** @typedef {import('@growthcloud/core').Uppy} Uppy */
/** @typedef {import('@growthcloud/core').UppyFile} UppyFile */
/** @typedef {import('@growthcloud/core').FailedUppyFile<{}>} FailedUppyFile */
