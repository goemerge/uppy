...
See [#414 PR](https://github.com/goemerge/uppy/pull/414) for details.
...
See [`uppy.upload()`](https://uppy.io/docs/uppy/#uppy-upload) and [`core:complete`](https://uppy.io/docs/uppy/#core-complete) in docs, as well as [#404 PR](https://github.com/goemerge/uppy/pull/404) for more details.
...
See [#418 PR](https://github.com/goemerge/uppy/pull/418) for details.
...
- XHRUpload now includes a timeout `opts.timeout = 30000`, after which it errors and offers a retry (retry UI supported in Dashboard), see [#378](https://github.com/goemerge/uppy/pull/378) for more.
