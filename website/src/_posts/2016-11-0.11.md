...
- We wrote an [ARCHITECTURE.md](https://github.com/goemerge/uppy/blob/master/ARCHITECTURE.md) document, describing our architecture and APIs.
...
- [Fixed a bug](https://github.com/goemerge/uppy/issues/126) with `autoProceed: true` duplicating uploads.
...
- [Grand refactor of Uppy Server](https://github.com/goemerge/uppy/pull/131) with dynamic controllers.
