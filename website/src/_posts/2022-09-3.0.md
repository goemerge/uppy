...
- Our [examples](https://github.com/goemerge/uppy/tree/main/examples) have received a fresh round of updates to keep them relevant.

---

![Animate picture of a visibly happy dog getting a head massage](/images/blog/3.0/dog-enjoys.gif)

For more details, see the full [changelog](https://github.com/goemerge/uppy/blob/HEAD/CHANGELOG.md#1300) and the [migration guide](/docs/migration-guides.html).
