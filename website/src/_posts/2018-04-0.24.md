...
- Fixed security vulnerability in transient dependency [#70](https://github.com/goemerge/uppy-server/issues/70)
...
- Added an example project to run Uppy Server on Serverless, [see](https://github.com/goemerge/uppy-server/tree/master/examples/serverless).
