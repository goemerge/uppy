...
- [Artur](https://github.com/arturi) updated the [React Native](https://github.com/goemerge/uppy/pull/988) UI example. This is what the new UI looks like:
...
- Alex continues improving Uppy's UI and has recently been refactoring CSS code, while [Evgenia](https://github.com/lakesare) keeps charging at the [many accessibility issues](https://github.com/goemerge/uppy/issues/created_by/nqst) that are still open.
